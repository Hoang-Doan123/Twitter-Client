...
public class ExploreArtFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_explore_art, container, false);
        ...
        swipeRefreshLayout = view.findViewById(R.id.swipe_refresh_layout_explore_art);
        recyclerView = view.findViewById(R.id.recycler_view_explore_art);

...
public class ExploreAnimalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_explore_animal, container, false);
        ...
        swipeRefreshLayout = view.findViewById(R.id.swipe_refresh_layout_explore_animal);
        recyclerView = view.findViewById(R.id.recycler_view_explore_animal);

...
public class SearchEntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_search_entertainment, container, false);

        tabLayoutTop = getActivity().findViewById(R.id.home_tab_layout_top);
        tabLayoutBot = getActivity().findViewById(R.id.tab_layout_bot);

        swipeRefreshLayout = view.findViewById(R.id.swipe_refresh_layout_search_entertainment);
        recyclerView = view.findViewById(R.id.recycler_view_search_entertainment);
